...
import java.awt.*;  
import java.sql.*;  
public class UserBookingView extends JFrame implements ActionListener {  
//Initializing Components  
    ...
    UserBookingView() {  
        ...
        lb5 = new JLabel("Enter User name:");  
    ...
    public void actionPerformed(ActionEvent e) {  
        ...
        try {  
            ...
            PreparedStatement st = con.prepareStatement("select * from admin.ticket where cName=?");  
            st.setString(1, str);  
